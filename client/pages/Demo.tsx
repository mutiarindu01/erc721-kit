      ...
      {nfts.map(nft => (
        <div key={nft.id} className="border rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
          ...
          <div className="p-3">
            ...
            <Badge variant={nft.status === 'auction' ? 'default' : 'secondary'} className="mt-2 text-xs">
              {nft.status}
            </Badge>
          </div>
        </div>
      ...
      {escrows.map(escrow => (
        <div key={escrow.id} className="border rounded-lg p-4">
          ...
          <div className="text-sm space-y-1">
            <p><span className="font-medium">Price:</span> {escrow.price}</p>
            <p><span className="font-medium">Buyer:</span> {escrow.buyer}</p>
            <p><span className="font-medium">Seller:</span> {escrow.seller}</p>
          </div>
...
export default function Demo() {
  ...
  const setupSteps = [
    { title: 'Download Kit', description: 'Download the complete ERC721 Kit package', status: 'completed' },
    { title: 'Install Dependencies', description: 'Run npm install to install all dependencies', status: 'completed' },
    { title: 'Deploy Contracts', description: 'Deploy smart contracts to your preferred network', status: 'in-progress' },
    { title: 'Configure Frontend', description: 'Update contract addresses in frontend config', status: 'pending' },
    { title: 'Launch Application', description: 'Start your NFT marketplace application', status: 'pending' }
  ];

  const features = [
    {
      title: 'Smart Contracts',
      description: 'Production-ready contracts with escrow, marketplace, and royalty features',
      items: ['ERC721Escrow.sol', 'ERC721Marketplace.sol', 'RoyaltyEngine.sol', 'MockNFT.sol']
    },
    {
    ...
    },
    {
      ...
      items: ['Deploy Scripts', 'Test Suite', 'Verification Tools', 'Documentation']
    }
  ];
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold mb-4">
            ERC721 Kit Live Demo
          </h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Experience the complete NFT marketplace solution in action. Test all components, 
            see the code, and understand how everything works together.
          </p>
        ...
        <Card className="mb-12">
          <CardHeader>
            ...
            <CardDescription>
              Experience the ERC721 Kit components in action. Click on different tabs to see various components.
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <div className="mt-6">
                <TabsContent value="gallery" className="space-y-4">
                  <div className="flex justify-between items-center">
                    <h3 className="text-lg font-semibold">NFT Gallery Component</h3>
                    <div className="flex gap-2">
                      <Button
                        size="sm"
                        variant="outline"
                        onClick={() => navigator.clipboard.writeText(demoCode.gallery)}
                      >
                ...
                <TabsContent value="mint" className="space-y-4">
                  <div className="flex justify-between items-center">
                    <h3 className="text-lg font-semibold">Mint Form Component</h3>
                    <div className="flex gap-2">
                      <Button
                        size="sm"
                        variant="outline"
                        onClick={() => navigator.clipboard.writeText(demoCode.mint)}
                      >
                        <Copy className="h-4 w-4 mr-2" />
                        Copy Code
                      </Button>
                ...
                <TabsContent value="escrow" className="space-y-4">
                  <div className="flex justify-between items-center">
                    <h3 className="text-lg font-semibold">Escrow Dashboard Component</h3>
                    <div className="flex gap-2">
                      <Button
                        size="sm"
                        variant="outline"
                        onClick={() => navigator.clipboard.writeText(demoCode.escrow)}
                      >
                        <Copy className="h-4 w-4 mr-2" />
                        Copy Code
                      </Button>
        ...
        <Card className="mb-12">
          <CardHeader>
            ...
            <CardDescription>
              Get your NFT marketplace running in minutes with these simple steps.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
        ...
        <Card className="mb-12">
          <CardHeader>
            ...
            <CardDescription>
              Complete package contents for building production-ready NFT marketplaces.
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <div className="text-center bg-primary/5 rounded-lg p-8">
          <h2 className="text-3xl font-bold mb-4">Ready to Build Your NFT Marketplace?</h2>
          <p className="text-lg text-muted-foreground mb-6 max-w-2xl mx-auto">
            Get the complete ERC721 Kit and launch your NFT marketplace in minutes, not months. 
