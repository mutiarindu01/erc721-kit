...
const Layout = () => {
  ...
  const { isConnected, account, formatAddress, chainId, isNetworkSupported } =
    useWallet();
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <p className="text-red-700 dark:text-red-300 text-sm">
                  You're connected to an unsupported network. Please switch to a
                  supported network.
                </p>
              </div>
              <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <p className="mt-4 text-gray-600 dark:text-gray-400 text-sm">
                A comprehensive NFT marketplace built with ERC721 Kit, featuring
                secure escrow and trading.
              </p>
            </div>
