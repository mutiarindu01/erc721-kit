...
const EscrowDashboard = ({
  ...
  const tabs = [
    { id: "all", label: "All Escrows", count: escrows.length },
    {
      id: "buyer",
      label: "As Buyer",
      count: escrows.filter(
        (e) => e.buyer?.toLowerCase() === userAddress?.toLowerCase(),
      ).length,
    },
    {
      id: "seller",
    ...
    },
    {
      id: "active",
      label: "Active",
      count: escrows.filter((e) => e.status === "Active").length,
    },
    {
      id: "completed",
      label: "Completed",
      count: escrows.filter((e) => e.status === "Completed").length,
    },
    {
      id: "disputed",
      label: "Disputed",
      count: escrows.filter((e) => e.status === "Disputed").length,
    },
  ];
              ...
              >
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <span
                      className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(escrow.status)}`}
                    >
                      {escrow.status}
                    </span>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-900 font-mono">
                        {formatAddress(escrow.nftContract)}
                      </p>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-gray-700">
                ...
                {escrow.status === "Active" && (
                  <div className="mt-4">
                    <div className="flex items-center justify-between text-sm text-gray-600 mb-2">
                      <span>Progress</span>
                      <span>
                        {(escrow.sellerApproved ? 1 : 0) +
                          (escrow.buyerApproved ? 1 : 0)}
                        /2 approvals
                      </span>
                    </div>
      ...
      <div className="bg-white rounded-lg p-6 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            />
            {errors.buyer && (
              <p className="text-sm text-red-600 mt-1">{errors.buyer}</p>
            )}
          </div>
          ...
          <div>
            ...
            />
            {errors.nftContract && (
              <p className="text-sm text-red-600 mt-1">{errors.nftContract}</p>
            )}
          </div>
          ...
          <div>
            ...
            />
            {errors.tokenId && (
              <p className="text-sm text-red-600 mt-1">{errors.tokenId}</p>
            )}
          </div>
