...
const MintForm = ({
  ...
  const validateForm = () => {
    ...
    if (formData.royaltyPercentage > 0 && !ethers.utils.isAddress(formData.royaltyRecipient)) {
      newErrors.royaltyRecipient = 'Valid recipient address required for royalties';
    }
    ...
    <form onSubmit={handleSubmit} className={`space-y-6 ${className}`}>
        ...
        <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md hover:border-purple-400 transition-colors">
          {formData.imagePreview ? (
            ...
            <div className="space-y-1 text-center">
              ...
              <p className="text-xs text-gray-500">PNG, JPG, GIF, MP4, MP3, GLB up to 10MB</p>
            </div>
          )}
        </div>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">Suggested: 5-10%. Maximum: 10%</p>
        </div>

        <div>
          <label htmlFor="royaltyRecipient" className="block text-sm font-medium text-gray-700">
          ...
          />
          {errors.royaltyRecipient && <p className="mt-1 text-sm text-red-600">{errors.royaltyRecipient}</p>}
        </div>
      </div>
      ...
      <div>
        ...
        />
        <p className="mt-1 text-sm text-gray-500">Content only visible to owner</p>
      </div>
      ...
      <div className="flex items-center">
        ...
        />
        <label htmlFor="explicitContent" className="ml-2 block text-sm text-gray-900">
